...
# --- Public marketing / SEO pages (static, crawlable; generated by tools/build_pages.py) ---
PUBLIC_PAGES = [
    "about", "features", "how-it-works", "faq", "privacy", "terms", "contact",
]

def _serve_static_page(slug: str):
    try:
...
# Register both /about and /about.html for every public page.
...
def serve_sitemap():
    ...
    urls = [("https://visionarysparks.in/", "1.0"),
            ("https://visionarysparks.in/features", "0.9"),
            ("https://visionarysparks.in/how-it-works", "0.9"),
            ("https://visionarysparks.in/about", "0.8"),
            ("https://visionarysparks.in/faq", "0.8"),
            ("https://visionarysparks.in/contact", "0.6"),
            ("https://visionarysparks.in/privacy", "0.4"),
            ("https://visionarysparks.in/terms", "0.4"),
            ("https://visionarysparks.in/login.html", "0.7")]
    items = "".join(
